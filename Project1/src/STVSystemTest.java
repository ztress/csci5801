...
public class STVSystemTest {
    ...
    public static void setUp() {
        ...
        expectedWinners1.get(c1).add(new STVBallot(new int[]{0,0,1}));
        ...
        expectedWinners1.get(a1).add(new STVBallot(new int[]{1,0,0}));
        ...
        expectedWinners1.get(a1).add(new STVBallot(new int[]{1,0,2}));
        expectedWinners1.get(a1).add(new STVBallot(new int[]{3,1,2}));
        ...
        expectedWinners2.get(d2).add(new STVBallot(new int[]{0,0,0,1}));
        ...
        expectedWinners2.get(b2).add(new STVBallot(new int[]{0,1,0,0}));
        ...
        expectedWinners3.get(d3).add(new STVBallot(new int[]{0,2,0,1,0,0,0}));
        expectedWinners3.get(d3).add(new STVBallot(new int[]{0,2,0,1,3,0,0}));
        expectedWinners3.get(d3).add(new STVBallot(new int[]{3,2,0,1,4,0,5}));
        expectedWinners3.get(d3).add(new STVBallot(new int[]{3,2,0,1,0,0,0}));
        expectedWinners3.get(d3).add(new STVBallot(new int[]{0,0,0,1,0,0,0}));
        expectedWinners3.get(d3).add(new STVBallot(new int[]{3,2,0,1,4,0,5}));
        ...
        expectedWinners3.get(c3).add(new STVBallot(new int[]{0,0,1,2,0,0,0}));
        expectedWinners3.get(c3).add(new STVBallot(new int[]{2,4,1,3,0,0,0}));
        expectedWinners3.get(c3).add(new STVBallot(new int[]{0,0,2,0,1,0,0}));
        expectedWinners3.get(c3).add(new STVBallot(new int[]{0,0,2,0,1,0,0}));
        expectedWinners3.get(c3).add(new STVBallot(new int[]{4,3,2,0,0,1,0}));
        Candidate b3 = new Candidate(1,"b");
        expectedWinners3.put(b3, new ArrayList<>());
        expectedWinners3.get(b3).add(new STVBallot(new int[]{2,1,3,0,0,0,0}));
        expectedWinners3.get(b3).add(new STVBallot(new int[]{2,1,3,0,0,0,0}));
        expectedWinners3.get(b3).add(new STVBallot(new int[]{0,1,2,0,0,3,0}));
        expectedWinners3.get(b3).add(new STVBallot(new int[]{2,1,3,0,0,0,0}));
        expectedWinners3.get(b3).add(new STVBallot(new int[]{2,1,3,0,0,0,0}));
        expectedWinners3.get(b3).add(new STVBallot(new int[]{0,1,2,0,0,3,0}));
        ...
        expectedLosers3.add(new Candidate(5,"f"));
    ...
    public void testShuffleOff1() {
        ...
        assertEquals(7, electionSOff1.getDroop());
    }
    ...
    public void testShuffleOff2() {
        ...
        assertEquals(6, electionSOff2.getDroop());
    }
